...
That single economic fact is the whole reason Upstream can exist. Reading every changelog on the internet was never worth a human. It is trivially worth a machine.

## What "watched" should mean

We built Upstream around a specific standard: silence must be information. If you hear nothing, that must *mean* nothing happened — not that nothing was seen.
